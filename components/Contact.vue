<template>
  <div id="contact" class="py-8 white black--text">
        ...
        <v-col class="text-center">
          ...
          <div>
            <v-btn
              ...
              nuxt
              text
              class="text-lowercase mt-6 text-sm-title text-md-h5 black--text"
            >
              doctormavix@gmail.com</v-btn
            >
          </div>
        </v-col>
      </v-row>
